      ...
      <div className="flex gap-4 flex-1 overflow-hidden">
        ...
        <div className="w-56 border-r border-gray-100 pr-4 overflow-y-auto">
          ...
          <button
            ...
            className={`w-full text-left px-3 py-2.5 mb-1 rounded-lg text-sm transition-all ${selectedHinario === 'all'
          ...
          {hinarios.filter(h => h.id !== 0).map((hinario) => (
            <div
              key={hinario.id}
              className={`group flex items-center gap-1 mb-1 rounded-lg transition-all ${selectedHinario?.id === hinario.id
                ? 'bg-blue-50'
                : 'hover:bg-gray-50'
                }`}
            >
              <button
                ...
                className={`flex-1 text-left px-3 py-2.5 text-sm ${selectedHinario?.id === hinario.id
